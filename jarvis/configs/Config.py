...
class Config:
    hardware: str = "L05C"
    account: str = os.getenv("MI_USER", "") if os.getenv("MI_USER") else MI_USER
    password: str = os.getenv("MI_PASS", "") if os.getenv("MI_PASS") else MI_PASS
    openai_key: str = os.getenv("OPENAI_API_KEY", "") if os.getenv("OPENAI_API_KEY") else OPENAI_API_KEY
    siliconflow_key: str = os.getenv("SILICONFLOW_API_KEY", "") if os.getenv("SILICONFLOW_API_KEY") else siliconflow_key
    ...
    proxy: str | None = None
    mi_did: str = os.getenv("MI_DID", "") if os.getenv("MI_DID") else MI_DID
    keyword: Iterable[str] = KEY_WORD
    change_prompt_keyword: Iterable[str] = CHANGE_PROMPT_KEY_WORD
    prompt: str = PROMPT
    mute_xiaoai: bool = mute_xiaoai
    bot: str = bot
    cookie: str = ""
